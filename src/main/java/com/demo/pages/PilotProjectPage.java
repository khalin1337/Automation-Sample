...
public class PilotProjectPage extends PageTools {
    ...
    private final By companyField = By.xpath("//div[@class='et_pb_contact']//input[@id='et_pb_contact_company_0']");
    private final By countryField = By.xpath("//div[@class='et_pb_contact']//select[@id='et_pb_contact_country_0']");
    ...
    public void chooseCountryField(String text) {
        selectOption(text,countryField);
    }
    public void fillCompanyField(String text) {
        type(text,companyField);
    }
    ...
    public boolean isErrorContainMessageEmptyCompanyField() {
        return getErrorMessages().contains("Company");
    }
    public boolean isErrorContainMessageEmptyTextField() {
        return getErrorMessages().contains("Message");
    }
    public boolean isErrorContainMessageEmptyCountryField() {
        return getErrorMessages().contains("Country");
    }
